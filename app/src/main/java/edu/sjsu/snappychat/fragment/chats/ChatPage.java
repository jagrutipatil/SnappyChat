                ...
                builder.setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        ...
                        if (items[item].equals("Take Photo")) {
                            ...
                            if (ActivityCompat.checkSelfPermission(ChatPage.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED ) {
                            ...
                            if (ActivityCompat.checkSelfPermission(ChatPage.this, Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED ) {
